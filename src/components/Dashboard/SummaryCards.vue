<template>
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
    <div class="card-theme rounded-2xl shadow p-4 text-center">
      ...
      <p class="text-2xl font-bold mt-1 text-[color:var(--color-primary)]">$11,245,300</p>
      <div class="text-xs text-[color:var(--color-secondary)] mt-1">持倉：78.5%</div>
    </div>
    <div class="card-theme rounded-2xl shadow p-4 text-center">
      <h3 class="text-sm text-[color:var(--color-secondary)]">今日損益</h3>
      <p class="text-2xl font-bold mt-1 text-[color:var(--color-line2)]">+2.4%</p>
      <div class="text-xs text-[color:var(--color-secondary)] mt-1">+$219.222</div>
    </div>
    <div class="card-theme rounded-2xl shadow p-4 text-center">
    ...
    <div class="card-theme rounded-2xl shadow p-4 text-center">
      ...
      <p class="text-2xl font-bold mt-1 text-[color:var(--color-primary)]">23%</p>
      <div class="text-xs text-[color:var(--color-secondary)] mt-1">尚餘 $20,000 元</div>
    </div>
  </div>
</template>
