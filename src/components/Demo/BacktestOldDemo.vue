<template>
  <div class="p-6 space-y-6">
    <!-- 頁首：回測工具說明 -->
    <div class="card-theme rounded-2xl shadow p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between">
      <div>
        <h1 class="text-2xl font-bold text-[color:var(--color-primary)]">🔍 回測模組</h1>
        <p class="text-sm text-[color:var(--color-secondary)] mt-1">
          模擬不同投資策略在過去市場的表現，以檢驗穩定性與報酬潛力。
        </p>
      </div>
      <button
        class="mt-4 sm:mt-0 px-4 py-2 rounded-lg text-sm bg-[color:var(--color-primary)] text-white hover:opacity-90 transition"
      >
        ▶️ 開始回測
      </button>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      <div class="card-theme rounded-2xl shadow p-4 text-center">
        ...
        <p class="text-2xl font-bold mt-2 text-[color:var(--color-line2)]">+12.7%</p>
      </div>
      <div class="card-theme rounded-2xl shadow p-4 text-center">
        <h3 class="text-sm text-[color:var(--color-secondary)]">最大回撤</h3>
        <p class="text-2xl font-bold mt-2 text-[color:var(--color-line3)]">-8.9%</p>
      </div>
      <div class="card-theme rounded-2xl shadow p-4 text-center">
        <h3 class="text-sm text-[color:var(--color-secondary)]">年化報酬</h3>
        <p class="text-2xl font-bold mt-2 text-[color:var(--color-primary)]">6.3%</p>
      </div>
      <div class="card-theme rounded-2xl shadow p-4 text-center">
        <h3 class="text-sm text-[color:var(--color-secondary)]">勝率</h3>
        <p class="text-2xl font-bold mt-2 text-[color:var(--color-primary)]">61%</p>
      </div>
    </div>
    ...
    <!-- 交易紀錄表 -->
    <div class="card-theme rounded-2xl shadow p-6">
      <h3 class="font-medium mb-3">📜 回測交易紀錄</h3>
      <table class="w-full text-sm">
        ...
        <tbody>
          <tr class="border-b border-[color:var(--color-border)]">
            <td class="py-2">2025-09-10</td>
            <td class="py-2 text-[color:var(--color-line2)]">買進</td>
            <td class="py-2 text-right">$500.00</td>
            <td class="py-2 text-right">100</td>
            <td class="py-2 text-right">$95,000</td>
          </tr>
          <tr>
            <td class="py-2">2025-09-25</td>
            <td class="py-2 text-[color:var(--color-line3)]">賣出</td>
            <td class="py-2 text-right">$530.00</td>
            <td class="py-2 text-right">100</td>
            <td class="py-2 text-right">$148,000</td>
          </tr>
        </tbody>
      </table>
    </div>
